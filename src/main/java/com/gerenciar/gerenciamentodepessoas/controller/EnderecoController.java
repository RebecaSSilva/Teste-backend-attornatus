package com.gerenciar.gerenciamentodepessoas.controller;

import com.gerenciar.gerenciamentodepessoas.model.EnderecoModel;
import com.gerenciar.gerenciamentodepessoas.repository.EnderecoRepository;
...
public class EnderecoController {
    ...
    @GetMapping
    public ResponseEntity<List<EnderecoModel>> todosEnderecos() {
        return ResponseEntity.ok(repository.findAll());
    }

    @GetMapping("/{id}")
    public ResponseEntity<EnderecoModel> enderecoPorId(@PathVariable Long id){
