...
import com.gerenciar.gerenciamentodepessoas.repository.PessoaRepository;
...
public class PessoaController {
    ...
    @GetMapping
    public ResponseEntity<List<PessoaModel>> todosEnderecos() {
        return ResponseEntity.ok(repository.findAll());
    }

    @GetMapping("/{id}")
    public ResponseEntity<PessoaModel> enderecoPorId(@PathVariable Long id) {
